...
namespace CreateFilterForEachView
{
    ...
    public class Class1 : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            double value = UnitUtils.ConvertToInternalUnits(15.0f, DisplayUnitType.DUT_SQUARE_METERS);

            // Notify for user
            TaskDialog.Show("Filter", "Filter all walls have area greater than 15 square meters");
