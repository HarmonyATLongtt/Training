...
//                    }
//                }
//                //List<PlanarFace> planarFacesParallelToZ = new List<PlanarFace>();
//                //List<MeshTriangle> triangles = new List<MeshTriangle>();
...
//            //pairs.Add((highestPoint, lowestPoint));
//            return cylinderInfo;
//        }
...
//            for (int i = 0; i < cylinderInfos.Count - 1; i++)
//            {
//                for (int j = i + 1; j < cylinderInfos.Count; j++)
//                {
